...
export const DEFAULT_GENERATION_WORKFLOW_MENU: MenuTreeDefinition = {
  ...
  nodes: [
    { id: "image", kind: "category", label: "Image", parentId: null, order: 0 },
    { id: "image.generate", kind: "folder", label: "Generate", parentId: "image", order: 0 },
    { id: "image.improve", kind: "folder", label: "Improve", parentId: "image", order: 1 },
    { id: "video", kind: "category", label: "Video", parentId: null, order: 1 },
    ...
    { id: "video.improve", kind: "folder", label: "Improve", parentId: "video", order: 3 },
  ],
  leafPlacements: [
    { leafId: "vlo_klein_multi.json", parentId: "image.generate", order: 0 },
    { leafId: "vlo_SeedVR2_image.json", parentId: "image.improve", order: 0 },
    ...
    { leafId: "vlo_SeedVR2_video.json", parentId: "video.improve", order: 0 },
    { leafId: "vlo_gimm_vfi.json", parentId: "video.improve", order: 1 },
  ],
};
