...
const VALUE_TABS: readonly CurveEditorTab[] = [
  { name: "curveMaster", label: "Y", color: "#fff", periodic: false, yMin: 0, yMax: 1, background: "linear-gradient(135deg, #09090b, #52525b)" },
  { name: "curveR", label: "R", color: "#ef4444", periodic: false, yMin: 0, yMax: 1, background: "linear-gradient(135deg, #09090b, #451a1a)" },
  { name: "curveG", label: "G", color: "#22c55e", periodic: false, yMin: 0, yMax: 1, background: "linear-gradient(135deg, #09090b, #14532d)" },
  { name: "curveB", label: "B", color: "#3b82f6", periodic: false, yMin: 0, yMax: 1, background: "linear-gradient(135deg, #09090b, #172554)" },
];

const HUE_TABS: readonly CurveEditorTab[] = [
  { name: "curveHueHue", label: "H→H", color: "#f8fafc", periodic: true, yMin: -0.5, yMax: 0.5, background: "linear-gradient(90deg, #ef4444, #eab308, #22c55e, #06b6d4, #3b82f6, #a855f7, #ef4444)" },
  { name: "curveHueSat", label: "H→S", color: "#f8fafc", periodic: true, yMin: -0.5, yMax: 0.5, background: "linear-gradient(90deg, #7f1d1d, #713f12, #14532d, #164e63, #1e3a8a, #581c87, #7f1d1d)" },
  { name: "curveLumaSat", label: "L→S", color: "#f8fafc", periodic: false, yMin: -0.5, yMax: 0.5, background: "linear-gradient(90deg, #000, #fff)" },
];
