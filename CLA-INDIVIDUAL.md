...
Thank you for your interest in contributing to **vlo** ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. **By submitting a contribution to vlo (for example, by
opening a Pull Request on GitHub), you implicitly accept and agree to the
terms of this Agreement.** This is a legally binding document, so please read
it carefully before contributing. The Agreement may cover more than one
...
- **"Contribution"** means any work of authorship that is Submitted by You to
  Us in which You own or assert ownership of the Copyright. If You do not own
  the Copyright in the entire work of authorship, please follow the
  instructions in Section 3(d).
...
- **"Submit"** means any form of electronic, verbal, or written communication
  ...
  mailing lists, source code control systems (such as GitHub), and issue
  tracking systems that are managed by, or on behalf of, Us for the purpose of
  discussing and improving the Material, but excluding communication that is
...
Creative Commons Attribution 4.0 International (CC BY 4.0), including any
right to adopt any future version of the license if permitted.
...
You will clearly identify the original copyright holder, the applicable
open-source license, and provide a link to the original source code in the
description of your GitHub Pull Request, as well as within the header comments
of the contributed file(s).
...
England and Wales excluding its conflicts of law provisions. Under certain
