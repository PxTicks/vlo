...
const ALLOWLIST = [
  "app/layout/RightSidebarPanel.tsx",
  "features/composite/CompositeBrowser.tsx",
  "features/composite/services/bakeComposite.ts",
  ...
  "features/generation/store/metadata.ts",
  ...
  "features/renderer/services/projectFrameCapture.ts",
  ...
  "features/timelineSelection/utils/assetSelection.ts",
